        ...
        <div className="five-row flex sb">
          <div className="like flex">
            <div className="social-icons flex f-clmn">
              ...
              <a target="_blank" href="https://github.com/guristacks">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a target="_blank" href="https://www.instagram.com/guristacks/">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <div className="touch flex f-clmn">
            ...
            <p>
              <i aria-hidden="true" className="ri-navigation-fill"></i>{" "}
              Stacks <br /> Dhuri Dist. Sangrur, Punjab India.
            </p>
            <p>
              <a
                target="_blank"
